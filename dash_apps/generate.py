...
def screen_and_interpret_topic(text, lang='en'):
    ...
    try:
        ...
        prompt = (
            ...
            "(ornek: 'telefonuma ait makale' -> 'mobil iletisim teknolojileri ve akilli telefonlar'; "
            "'kahve' -> 'kahvenin biyokimyasi ve saglik etkileri'). Yalnizca acikca alay/manipulasyon/"
            "zarar amacli ya da hicbir bilgi degeri olmayan metinleri REDDET.\n"
