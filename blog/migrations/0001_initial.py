...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('service_name', models.CharField(choices=[('Google Gemini', 'Google Gemini'), ('OpenAI', 'OpenAI'), ('Anthropic', 'Anthropic')], max_length=100, verbose_name='Servis Adı')),
                ('model_name', models.CharField(help_text='Örn: gemini-1.5-pro, gpt-4o', max_length=100, verbose_name='Model Adı')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(allow_unicode=True, always_update=True, editable=False, max_length=255, populate_from='title', slugify=blog.utils.custom_slugify, unique=True)),
                ('cover_image', models.ImageField(blank=True, help_text='Makale listeleme ve paylaşım için kullanılacak kapak fotoğrafı.', null=True, upload_to='article_covers/', verbose_name='Kapak Fotoğrafı')),
